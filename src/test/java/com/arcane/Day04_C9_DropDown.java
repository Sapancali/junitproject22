...
//6.sizeTest methodu olusturun ve dropdown size'ini bulun
    ...
    public void selectByIndexTest(){
        ...
        //2. select object oluştur
        Select select=new Select(dropDown);
        //3. methoddan herhangi birini kullanarak element bulun= selectByIndex, selectByValue, selectByVisibleText
    ...
    public void printAllText(){
        WebElement dropdown=driver.findElement(By.id("dropdown"));
        Select select=new Select(dropdown);
        // getOptions() == dropdown daki tüm seçenekleri bir List<WebElement> olarak döndürür
    ...
    public void sizeTest(){
        ...
        // dropdown size'ini bulun, eger dropdown'da 4 element yok ise "Beklenen ile Acutual'ın esit degildir" yazdirin.
        Assert.assertEquals("Beklenen ile Acutual esit degildir",3,size);
    }
    @After
