...
//    3- Mesajin “It's gone!” oldugunu verify edin
    ...
    1. WebDriverWait object oluştur
    WebDriverWait wait = new WebDriverWait(driver,10)
    2.wait object kullannarak element yüklemesi için bekleme ekle
     */
    WebDriverWait wait=new WebDriverWait(driver,10);
    /*Explicitly wait aşagıdaki islemliri yapar
    1. driver.findElement(By.id("message")) elementi bulmak için 10 saniye kadar bekler
    2. Eğer elementi 10 saniyede bulursa WebElement olarak döner
    3. Eger elementi 10 saniyede bulamazsa bu aşama başarısız olur
     */
