...
//    text box'i locate et
//    //1. yol iframe gecis icin index kullanma00 indexler 0'dan baslar
//    driver.switchTo().frame(1);
//    //2. yol iframe e gecis icin id/name value kullanma
//    //Eger iframe id ye sahipse bu durumda id value değerini iletiyoruz
...
//    Elemental Selenium text'in sayfada gosterildigini/displayed verify et
    //Elemental Selenium IFrame dışındadir
    //parent frame e gecis yapmak lazım
